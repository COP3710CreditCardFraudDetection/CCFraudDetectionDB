...
CREATE TABLE cardholder_location (
    ...
    FOREIGN KEY (city_id) REFERENCES city_details(city_id)		-- Ensures the state is valid based on the states table
);
...
CREATE TABLE merchant (
	...
	merchant_cat_id INT NOT NULL,			-- Foreign key linking to the merchant category table
